...
<section class="kategorie">
    <div class="container">
        <a style="color: black" href="paneladmina.php"> < Powrót do panelu </a>
    ...
    <div class="grid">
        <div class="grid-item border border-2 px-5 py-5">
            ...
            array_map(function($item){
                ...
                //echo $gatunek || 'asfg';
                //  || (isset($_GET['gatunek']) && $item['gatunek_filmu']) == $_GET['gatunek']
                if(!isset($_GET['gatunek'])){
                    ?>

                    <div class="item py-3 px-3 show <?php echo $item['gatunek_filmu'] ?? "Gatunek";?>" style="max-width:250px;">
                        <div class="film ">
                            ...
                            <div class="text-center py-3">
                                ...
                                <a href="ofilmie.php?id=<?php echo $item['id_film'] ?? "";?>">
                                    <button type="submit" class="btn btn-warning font-size-10 my-1">Sprawdź recenzje</button></a>
                            </div>
                        </div>
                    </div>
                    <?php
                    ...
                    <div class="item py-3 px-3 show <?php echo $item['gatunek_filmu'] ?? "Gatunek";?>" style="max-width:250px;">
                        <div class="film ">
                            ...
                            <div class="text-center py-3">
                                <h6><?php echo $item['tytul'] ?? "Nieznany";?></h6>
                                <a href="ofilmie.php?id=<?php echo $item['id_film'] ?? "";?>">
                                    <button type="submit" class="btn btn-warning font-size-10 my-1">Zarezerwuj teraz</button></a>
                            </div>
                        </div>
                    </div>
                    <?php
